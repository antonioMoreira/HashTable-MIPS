...
str_menu: .asciiz "\n\n\t\t\t\t__MENU_HASH__\nEscolha:\n[1]-> Inserção.\t[2]-> Remoção.\t[3]-> Busca.\t[4]-> Imprimir.\t[-1]-> Sair.\n"				
str_insert: .asciiz "Digite uma chave para a inserção na tabela Hash(ou -1 para sair):\n"
str_remove: .asciiz "Digite uma chave para a remoção na tabela Hash(ou -1 para sair):\n"	
str_search: .asciiz "Digite uma chave para buscar na tabela Hash(ou -1 para sair):\n"	
...
main:
	...
	# $t7 esta sendo usado para garantir que os registradores temporários não 
...
loopRemove:
	...
	# remove o valor digitado da hash
	removeHash($s7,$t7)						
...
loopSearch:
	...
	# Procura o valor digitado na hash
	searchHash($s7,$t7)						
